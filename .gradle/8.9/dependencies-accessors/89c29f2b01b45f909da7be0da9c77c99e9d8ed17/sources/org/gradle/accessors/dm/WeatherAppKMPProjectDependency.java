...
@NonNullApi
public class WeatherAppKMPProjectDependency extends DelegatingProjectDependency {

    @Inject
    public WeatherAppKMPProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
